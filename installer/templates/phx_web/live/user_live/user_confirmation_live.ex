defmodule <%= @web_namespace %>.UserConfirmationLive do
  ...
  def render(%{live_action: :edit} = assigns) do
    ...
    <div class="max-w-sm mx-auto">
      <p class="text-center">Confirm Account</p>

      <.simple_form for={@form} id="confirmation_form" phx-submit="confirm_account">
        <.input field={@form[:token]} type="hidden" />
        <:actions>
          <.button phx-disable-with="Confirming..." class="w-full" label="Confirm my account" />
        </:actions>
      </.simple_form>
