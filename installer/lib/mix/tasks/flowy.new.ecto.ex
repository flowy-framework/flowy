defmodule Mix.Tasks.Flowy.New.Ecto do
  @moduledoc """
  ...
  It expects the name of the project as an argument.
      ...
      $ cd my_umbrella/apps
      $ mix flowy.new.ecto APP [--module MODULE] [--app APP]
  ...
  ## Examples
      ...
      $ mix flowy.new.ecto hello_ecto

  Is equivalent to:

      $ mix flowy.new.ecto hello_ecto --module HelloEcto
  """
  ...
  @impl true
  def run([]) do
    Mix.Tasks.Help.run(["flowy.new.ecto"])
  end
  ...
  def run([path | _] = args) do
    ...
    Mix.Tasks.Flowy.New.run(args ++ ["--no-assets", "--ecto"], Flowy.New.Ecto, :app_path)
  end
end
