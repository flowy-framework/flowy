defmodule Mix.Tasks.Flowy.Gen.Schema do
  ...
  Generates an Ecto schema and migration.
      ...
      $ mix flowy.gen.schema Blog.Post blog_posts title:string views:integer
  ...
  The generated schema above will contain:
    ...
    * a schema file in `lib/my_app/schemas/blog/post.ex`, with a `blog_posts` table
  ...
  the type makes it default to `:string`:
      ...
      $ mix flowy.gen.schema Blog.Post blog_posts title views:integer

  The following types are supported:

  #{for attr <- Mix.Flowy.Schema.valid_types(), do: "  * `#{inspect(attr)}`\n"}
  ...
  referenced table:
      ...
      $ mix flowy.gen.schema Blog.Post blog_posts title user_id:references:users
  ...
  type of the underlying array element to be given too:
      ...
      $ mix flowy.gen.schema Blog.Post blog_posts tags:array:string

  Unique columns can be automatically generated by using:

      $ mix flowy.gen.schema Blog.Post blog_posts title:unique unique_int:integer:unique

  Redact columns can be automatically generated by using:

      $ mix flowy.gen.schema Accounts.Superhero superheroes secret_identity:redact password:string:redact

  Ecto.Enum fields can be generated by using:

      $ mix flowy.gen.schema Blog.Post blog_posts title status:enum:unpublished:published:deleted
  ...
  a `--table` option may be provided. For example:
      ...
      $ mix flowy.gen.schema Blog.Post posts --table cms_posts
  ...
  folder with option `--repo`:
      ...
      $ mix flowy.gen.schema Blog.Post posts --repo MyApp.Repo.Auth
  ...
  the migration folder path:
      ...
      $ mix flowy.gen.schema Blog.Post posts --migration-dir /path/to/directory
  ...
  A prefix can be specified with the `--prefix` flags. For example:
      ...
      $ mix flowy.gen.schema Blog.Post posts --prefix blog
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise(
        "mix flowy.gen.schema must be invoked from within your *_web application root directory"
      )
    end
  ...
  def files_to_be_generated(%Schema{} = schema) do
    [{:eex, "schema.ex", schema.file}, {:eex, "schema_test.exs", schema.test_file}]
  end
  ...
  def copy_new_files(
    ...
    Mix.Flowy.copy_from(paths, "priv/templates/flowy.gen.schema", binding, files)
      ...
      migration_dir =
        cond do
          ...
          opts[:repo] ->
            ...
            Mix.Flowy.context_app_path(ctx_app, "priv/#{repo_name}/migrations/")

          true ->
            Mix.Flowy.context_app_path(ctx_app, "priv/repo/migrations/")
        end

      migration_path = Path.join(migration_dir, "#{timestamp()}_create_#{schema.table}.exs")

      Mix.Flowy.copy_from(paths, "priv/templates/flowy.gen.schema", binding, [
  ...
  def raise_with_help(msg) do
    ...
    mix flowy.gen.schema expects both a module name and
    the plural of the generated resource followed by
    any number of attributes:

        mix flowy.gen.schema Blog.Post blog_posts title:string
    """)
  end
